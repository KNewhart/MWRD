...
scaled.boxplot.png(nsec.online, "MWRD_nsec_online_boxplots_01.png")
...
scaled.boxplot.png(nsec.online, "MWRD_nsec_online_boxplots_02.png")
...
# sapply(data2plot, function(x) plot.xts(na.omit(x), main = colnames(x), grid.col = NA, yaxis.right = FALSE, format.labels ="%m/%d"))
scaled.boxplot.png(n.paa.online, "MWRD_npaa_online_boxplots_01.png", margins = c(13,6.5,0.5,0.5)+.1)
...
scaled.boxplot.png(n.paa.online, "MWRD_npaa_online_boxplots_02.png", margins = c(13,6.5,0.5,0.5)+.1)
...
scaled.boxplot.png(n.paa.grab, "MWRD_npaa_grab_boxplots_01.png", margins = c(12,6.5,0.5,0.5)+.1)
...
scaled.boxplot.png(n.paa.grab, "MWRD_npaa_grab_boxplots_02.png", margins = c(12,6.5,0.5,0.5)+.1)
# Create boxplots
...
![](MWRD_nsec_online_boxplots_01.png)
</div>
**Figure 1a.** Raw north secondary data.

<div custom-style="FigureCenter">
![](MWRD_nsec_online_boxplots_02.png)
</div>
...
<div custom-style="FigureCenter">
![](MWRD_nsec_online_boxplots_03.png)
</div>
...
![](MWRD_Ecoli_nseconline_lm-ras.png)
</div>
...
png("MWRD_Ecoli_nseconline_glm.png", units = "in", res = 200, width = 6, height = 3*2.5, family="A", pointsize = 10)
...
png("MWRD_Ecoli_vis_glm.png", units = "in", res = 200, width = 6, height = 3*2.5, family="A", pointsize = 10)
par(mar=c(5,5,.5,.5), mfrow=c(3, 2))
visreg::visreg(glm.vis.ecoli.data, ylab="Pre-disinf E. coli (LOG MPN/100mL)")
dev.off()
```
<div custom-style="FigureCenter">
![](MWRD_Ecoli_vis_glm.png)
</div>
**Figure 3a.** GLM model constructed for visual spectrum data.

<div custom-style="FigureCenter">
![](MWRD_Ecoli_nseconline_glm.png)
</div>
...
png("MWRD_Ecoli_vis_pca.png", units = "in", res = 200, width = 6.5, height = 6.5, family="A", pointsize = 24)
