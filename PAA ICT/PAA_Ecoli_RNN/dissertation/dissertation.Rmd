...
plot(x=actual,
     ...
     pch=20, xlab="", ylab="")
mtext(text="Actual Integrated CT", side=1, line=2.75)
mtext(text="Predicted PAA, Integrated CT", side=2, line=2.75)
abline(a=0, b=1)
```
...
```{r Ecoli log removal calcs, eval=FALSE, include=FALSE}
library(plot3D)
