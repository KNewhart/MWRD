...
```{r plot PAA squared error v2, echo=FALSE}
# 1: 2018 or 2019
...
if(!("results/ct-var-results-ls-v2.RData" %in% list.files(recursive=TRUE))) {
  load("results/ct-all-results-ls-v2.RData") # CT is all.results.ls[[1]][,4]
...
save(all.results.ls, file="results/ct-var-results-ls-v2.RData")
} else {
  load("results/ct-var-results-ls-v2.RData")
}
```
...
```{r Build Ecoli RNN 50-50, include=FALSE}
if(!("results/ecoli-rnn-50-50-all-results-ls-v2.RData" %in% list.files(recursive=TRUE))) { 
...
save(all.results.ls, file="results/ecoli-rnn-50-50-all-results-ls-v2.RData")
} else {
  load("results/ecoli-rnn-50-50-all-results-ls-v2.RData")
}
```
