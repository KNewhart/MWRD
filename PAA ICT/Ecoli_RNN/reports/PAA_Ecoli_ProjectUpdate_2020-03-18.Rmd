...
output:
  word_document:
     ...
     reference_docx: C:/Users/kbnewhart/Dropbox/Code/MWRD/PAA ICT/Ecoli_RNN/src/word_template.docx
...
Figure `r fig<-fig+1;fig`: North *E. coli* for training and testing period
...
Figure `r fig<-fig+1;fig`: South *E. coli* for training and testing period
...
# Actual RMSE and Persistence RMSE
# layout(mat=matrix(c(1,2), ncol=2, byrow = TRUE), widths=c(0.5,0.5), heights=c(1), TRUE)
par(mar=c(3.5,4,1.5, 0.1), family="serif")
data <- do.call("rbind", lapply(1:ncol(rmse), function(i) {
  data <- rmse[,i]
