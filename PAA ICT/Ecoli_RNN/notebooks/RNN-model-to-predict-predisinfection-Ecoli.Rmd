...
instant.data.log.lag <- cbind(instant.data.log.lag[2:nrow(instant.data.log.lag),], 
                              instant.data.log.lag[1:(nrow(instant.data.log.lag)-1),which(colnames(instant.data.log.lag)=="ECIDX_G")])
colnames(instant.data.log.lag)[ncol(instant.data.log.lag)] <- "ECIDX_G_Lag"
instant.data.log.lag <- instant.data.log.lag[-1,]
