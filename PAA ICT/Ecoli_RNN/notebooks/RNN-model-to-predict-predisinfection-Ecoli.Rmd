...
average.data.log.lag <- cbind(average.data.log.lag[3:nrow(average.data.log.lag),], 
                              average.data.log.lag[1:(nrow(average.data.log.lag)-2),which(colnames(average.data.log.lag)=="ECIDX_G")])
...
instant.data.log.lag[,which(colnames(instant.data.log.lag)=="ECIDX_G")] <- log10(instant.data.log.lag[,which(colnames(instant.data.log.lag)=="ECIDX_G")])
instant.data.log.lag <- cbind(instant.data.log.lag[3:nrow(instant.data.log.lag),], 
                              instant.data.log.lag[1:(nrow(instant.data.log.lag)-2),which(colnames(instant.data.log.lag)=="ECIDX_G")])
...
test.instant <- rolling.rnn(all.data=instant.data.log.lag, 
